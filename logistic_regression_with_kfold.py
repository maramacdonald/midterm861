...
dataset2 = dataset2.drop('horoscope', axis=1)
dataset2 = dataset2.drop('region', axis=1)
dataset2 = dataset2.drop('personality8', axis=1)
dataset2 = dataset2.drop('gender', axis=1)

new_data = dataset2.iloc[:,0:10].values
finaltarget = machine.predict(new_data)
#print(finaltarget)
dataset2['gamepredictions'] = finaltarget
dataset2.to_csv("gamepredictions.csv")
